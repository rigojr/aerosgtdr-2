	      ...
	      <div class="bg-dark p-4">
	        ...
	        <p class="text-white">Menú de navegación</p>
	       		<div class="supra-info">
					<ul class="nav">
						<li class="nav-item">
							<p><img src="<?php echo get_template_directory_uri(); ?>/assets/img/phone-logo.png" alt="call us"><a href="tel:1-829-410-0286">+1 (829) 410-0286</a></p>
						</li>
					</ul>
				</div>
	          <div class="rrssB">
	        ...
	        <ul class="navbar-nav mr-auto">
	          ...
	          <li class="nav-item">
	            <a id="movF" class="nav-link" href="#">Contacto</a>
	          </li>
	          <li class="nav-item idioma">
	            <a class="nav-link" href="<?php echo esc_url( home_url( '/' ) ); ?>/#">English</a>
	          </li>
	        </ul>
	      </div>
	    </div>
